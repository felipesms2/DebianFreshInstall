...
# Common Software
sudo apt update;
apt install -y p7zip-full p7zip-rar iproute2 zsh mousepad git libfuse2 chromium-browser gnome-disks pcmanfm lxtask gparted libavcodec-extra install libdvdcss2  tor vlc iputils-ping okular goldendict sqlitebrowser curl libreoffice htop neofetch geomview firefox wine -y
